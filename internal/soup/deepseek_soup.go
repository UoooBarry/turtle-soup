...
func FetchSoupFromDS(soupService *service.SoupService) error {
	...
	systemPrompt := `用户会让你生成海龟汤，你将会把汤面汤底和标签转换成纯JSON格式
        ...
        json
        {
            ...
            tag: ['红汤', '本格'],
            soup_answer: '这个男人曾经遭遇海难，和同伴（可能是亲人或挚友）在海上漂流，濒临饿死。同伴为了让他活下去，谎称煮了“海龟汤”给他喝，但实际上是用自己的血肉熬制的。男人活了下来，但同伴牺牲了。多年后，他在餐厅点了真正的海龟汤，尝出味道完全不同，瞬间明白当年的真相，因无法承受巨大的愧疚与悲痛，选择自杀.'
        }
    `
